...
class Simulation(object):
    ...
    def GeneratePhotons(self):
        ...
        # Photons in this configuration will be emitted downwards towards the cathode 
            ...
            MuonFile = MuonGen.MuonGen2(numOfMuons, 'Output.csv')
            print(MuonFile, numOfMuons)
            MuonData = ReadMuonsFromCSV2.ReadMuonsFromCSV2('Output.csv')
            #print(MuonData) 
